        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          ...
          <motion.div variants={fadeLeft}>
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-blue-100 sm:text-xl">
              New Way Consultancy & Placement helps individuals 
              find the right direction through educational 
              guidance, career counselling, career development, 
...
>
  ...
  <div className="relative z-10 grid min-h-[500px] md:grid-cols-[1fr_1.05fr]">
    ...
    <div className="relative flex flex-col justify-between border-b border-white/10 p-8 md:border-b-0 md:border-r md:p-10">
      ...
      {/* PURPLE RIBBON */}
      <svg
        className="pointer-events-none absolute -bottom-2 -left-28 h-64 w-[600px]"
        viewBox="0 0 600 260"
        fill="none"
      ...
      >
        ...
        <motion.path
          d="M-40 55 C80 175 170 185 275 115 C370 52 425 75 500 145 C550 195 610 215 680 150"
